...
// let boApiUrl = process.env.VUE_CONFIG_BO_API || config.VUE_CONFIG_BO_API;
//
// boApiUrl = boApiUrl.replace(/"/g, "");
// boApiUrl = boApiUrl.replace(/\\/g, "");
// let identityApiUrl =
//   process.env.VUE_CONFIG_IDENTITY_API || config.VUE_CONFIG_IDENTITY_API;
// identityApiUrl = identityApiUrl.replace(/"/g, "");
// identityApiUrl = identityApiUrl.replace(/\\/g, "");
// let retry:boolean=false
// let is_manage:boolean=false
//
...
//   }
// };
// export default (api: string,manage?:boolean): AxiosInstance => {
//     if(manage){
//       is_manage=manage
//     }
//   switch (api) {
